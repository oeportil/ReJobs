...
public interface CandidatoRepository extends JpaRepository<Candidato, Integer>{
    ...
    @Query("SELECT new com.reware.rejobs.dto.CandiVacanteDTO( " +
        ...
        "CASE WHEN c.contacto IS NULL THEN 0 " +
        "     WHEN c.contacto = true THEN 1 " +
        "     ELSE 2 END, c.revisado, c.usuario.nombre, c.usuario.apellido, c.usuario.email, c.usuario.telefono, c.usuario.pfp, c.usuario.id, c.vacante.nombre, c.vacante.empresa, c.vacante.id) " +
